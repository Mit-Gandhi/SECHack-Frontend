    ...
    return (
        <div>
            ...
            <footer className="bg-[#1E3D58] text-[#E8EEF1]">
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 block md:flex  justify-between items-center">
                    <div className=' flex flex-col justify-center items-center p-2 w-full md:w-[40%]'>
                        ...
                        <div className='text-[22px] font-bold text-[#F2EFDF]'>Neural Security</div>
                    </div>
                    <div className="content w-full md:w-[60%] flex justify-center items-center flex-col gap-5">
                        <div className="description text-center w-[100%] ">AI-powered surveillance isn’t the future, it’s the present. Upgrade your security systems with real-time suspect identification and instant alerts.</div>
                        <div className="Links">
                            <div className="flex   mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 justify-center items-center">
                                ...
                                <Link className='block py-2 pr-4 pl-3 text-gray-700 border-b border-[#E8EEF1] hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700' href={"/survellance"}>Surveillance</Link>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="copyright bg-[#1E3D58]">
                ...
                <span className="block text-sm text-gray-500 text-center dark:text-gray-400 py-3">© 2025 <a href="" className="hover:underline">NeuralSecurity</a>. All Rights Reserved.</span>
            </div>
        </div>
    )
}
